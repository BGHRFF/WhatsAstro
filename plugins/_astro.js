...
const Lang = Language.getString('astro');

if (Config.WORKTYPE == 'private') {

    Astro.addCommand({pattern: 'astro ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *WhatsAstro Private* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
            var CMD_HELP = '';
            Astro.commands.map(
    ...
    Astro.addCommand({pattern: 'astro ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
