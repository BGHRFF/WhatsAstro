...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './whasastro.db' : process.env.DATABASE_URL;
DEBUG = process.env.DEBUG === undefined ? false : convertToBool(process.env.DEBUG);

module.exports = {
    VERSION: 'v1.0',
    CHANNEL: 'https://t.me/WhatsAstroPlugin',
    SESSION: process.env.ASTRO_SESSION === undefined ? '' : process.env.ASTRO_SESSION,
    ...
    DATABASE: DATABASE_URL === './whatsastro.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
